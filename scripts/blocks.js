...
export const blocks = {
  ...
  // --- Solid color blocks for AI themes / structures (favela, cyberpunk...) ---
  favelaRed:    { id: 15, name: 'favelaRed',    material: new THREE.MeshLambertMaterial({ color: 0xb5482f }) },
  favelaYellow: { id: 16, name: 'favelaYellow', material: new THREE.MeshLambertMaterial({ color: 0xe3b23a }) },
  favelaBlue:   { id: 17, name: 'favelaBlue',   material: new THREE.MeshLambertMaterial({ color: 0x3f7bbf }) },
  favelaTeal:   { id: 18, name: 'favelaTeal',   material: new THREE.MeshLambertMaterial({ color: 0x2fa39b }) },
  concrete:     { id: 19, name: 'concrete',     material: new THREE.MeshLambertMaterial({ color: 0x9a978d }) },
...
export const FAVELA_WALLS = [15, 16, 17, 18, 19];
